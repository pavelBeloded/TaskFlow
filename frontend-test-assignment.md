...
- Доска содержит колонки (например: «To Do», «In Progress», «Done») done
- При создании доски — 3 колонки по умолчанию done
- Добавление / удаление колонок
- Переименование колонки

#### 1.4 Задачи (карточки) - Done

- Создание задачи в колонке (название) done
...
#### 2.5 Профиль пользователя - Done

- Страница профиля: имя, аватар
- Отображение аватара в карточках задач и комментариях -- Done
